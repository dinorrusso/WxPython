...
class Mywin(wx.Frame): 
   def __init__(self, parent, title): 
      ...
      db_sbox = wx.StaticBox(panel, -1, 'Database') 
      dbSizer = wx.StaticBoxSizer(db_sbox, wx.VERTICAL) 
      ...
      dbSizer.Add(nmbox, 0, wx.ALL|wx.CENTER, 10)  
      ...
      vbox.Add(dbSizer,0, wx.ALL|wx.CENTER, 5) 
